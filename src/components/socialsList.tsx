...
const SocialsList = () => {
    ...
    return (
        <div className='flex flex-col w-full gap-2 h-fit'>
            <p className='flex items-center justify-start h-7 pl-2 font-semibold text-[--primaryText] bg-gradient-to-r from-[--primary] via-[--thirdly] via-55% to-transparent'>Socials</p>
