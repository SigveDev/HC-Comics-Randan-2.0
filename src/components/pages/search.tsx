...
import { Art, Chapter, LikesRequest, Search as SearchType } from '../../assets/types';
...
const SearchPage = () => {
    ...
    return (
        <div className='flex flex-col items-center justify-center w-full h-full'>
            <div className='flex flex-col items-center justify-center w-2/5 gap-2 mt-8 h-fit'>
                <div className='flex flex-row items-center justify-start w-full h-1/2'>
                    <form onSubmit={handleSearch} className='flex flex-row w-full h-full'>
                        <input
                            className='w-full h-12 text-lg font-semibold text-[--primaryText] bg-[--secondary] outline-none p-2 border-[--primary] border-t-2 border-b-2 border-l-2'
                            placeholder='Search'
                ...
                <div className='flex flex-row items-center justify-end w-full gap-2 h-1/2'>
                    <button
