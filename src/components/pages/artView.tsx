...
import { checkUserData, getArtImage, giveArtView, likeArtToggle, shareArt, getArtById, getLiked } from '../../lib/Appwrite';
...
const ArtView = () => {
    ...
    useEffect(() => {
        const fetchLikedArt = async () => {
            ...
            setLiked(likedArt.documents[0].Art.find((likedArt: Art) => likedArt.$id === artId) ? true : false);
        }
        fetchLikedArt();
    }, []);
