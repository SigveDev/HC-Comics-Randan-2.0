  ...
  return (
    <div className="w-full h-fullpage bg-[--background] flex items-center justify-center flex-col">
      <div className="flex flex-col items-center justify-center w-1/3 gap-2 h-2/3">
        ...
        <form
          className="w-full h-fit text-[--primaryText] flex flex-col items-center gap-2 py-4"
        ...
        >
          <input
            ...
            className="w-full h-10 p-2 text-[--primaryText] bg-[--secondary] focus-visible:outline-none mb-4"
          />
          <input
            type="password"
