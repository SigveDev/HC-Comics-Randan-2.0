...
const SocialViewH = (social: Socials) => {
    ...
    return (
        <a href={social.link} className='flex flex-row items-center justify-start w-full gap-4 p-2 h-fit bg-[--secondary]'>
            {image && <img className='w-10 h-10' src={image.href} alt={social.name} />}
