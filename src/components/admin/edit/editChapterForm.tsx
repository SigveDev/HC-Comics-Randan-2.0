...
const EditChapterForm = () => {
  ...
  useEffect(() => {
    const fetchChapter = async () => {
      ...
      setChosenThumbnail(chapter.thumbnail);
      setChosenPages(chapter.pages);
      setChosenTitle(chapter.Titles.$id);
      setChapterIndex(chapter.number);
      setDescription(chapter.description);
      setChosenColorPalette(chapter.ColorPalette.$id);
      setSubtitle(chapter.subtitle);
    };
    fetchChapter();
  }, [chapterId, existingTitles]);
